...
dataset_path = 'C:/Users/13717/Desktop/experiment_data'
sub_sets = ['GOT-10k_Train_split_01']
...
def crop_video(video, d_set, crop_path, instanc_size):
    if video != 'list.txt':
        ...
        for idx, gt_line in enumerate(groundtruth):
            ...
            im = cv2.imread(join(images_path,str(idx+1).zfill(8)+'.jpg'))  # zfill(8)表示每张图片名字由8个数字组成
...
def main(instanc_size=255, num_threads=12):
