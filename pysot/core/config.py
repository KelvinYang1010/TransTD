...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'C:/Users/13717/Desktop/sot_experiment/TransTD/train_dataset/got10k/crop255'         # GOT dataset path
__C.DATASET.GOT.ANNO = 'C:/Users/13717/Desktop/sot_experiment/TransTD/train_dataset/got10k/train.json'
...
# Train layers
# __C.BACKBONE.TRAIN_LAYERS = ['layer2', 'layer3', 'layer4']  # ResNet50训练2、3、4层
# __C.BACKBONE.TRAIN_LAYERS = ['layer3', 'layer5', 'layer7']  # mobilenetv2训练3、5、7层
__C.BACKBONE.TRAIN_LAYERS = ['layer2', 'layer4', 'layer6']  # FasterNet训练2、4、6层
...
__C.HP_SEARCH.OTB100 = [0.35, 0.2, 0.45]  # 测试OTB100 dataset超参数

__C.HP_SEARCH.OTB_DR = [0.35, 0.2, 0.45]  # 测试TD-dataset超参数

__C.HP_SEARCH.GOT10K = [0.7, 0.06, 0.1]   # 测试GOT10K dataset超参数
