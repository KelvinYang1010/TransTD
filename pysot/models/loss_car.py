...
class TransTDLossComputation(object):
    """
    This class computes the TransTD losses.
    """

    def __init__(self,cfg):
        # self.box_reg_loss_func = IOULoss()  # 边界框损失为IOULoss
        self.box_reg_loss_func = GIOULoss()  # 边界框损失为GIOULoss
...
def make_transtd_loss_evaluator(cfg):
    loss_evaluator = TransTDLossComputation(cfg)
