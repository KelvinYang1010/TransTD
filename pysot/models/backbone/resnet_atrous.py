...
class ResNet(nn.Module):
    def __init__(self, block, layers, used_layers):
        ...
        # layer2重复4次Bottleneck，输出通道数为512
        ...
        # layer3重复6次Bottleneck，输出通道数为1024
        if layer3:
        ...
        # layer4重复3次Bottleneck，输出通道为2048
        if layer4:
...
if __name__ == '__main__':
    ...
    # print(net)
    net = net.cuda()
    x = torch.FloatTensor(1, 3, 127, 127).cuda()
    print(x.shape)

    out = net(x)
    print("layer2的输出:", out[0].shape)
    print("layer3的输出:", out[1].shape)
    print("layer4的输出:", out[2].shape)
