...
from pysot.tracker.transtd_tracker import TransTDTracker
...
parser = argparse.ArgumentParser(description='transtd tracking')
...
parser.add_argument('--snapshot', type=str, default='./snapshot/checkpoint_e49.pth',
        help='snapshot of models to eval')

parser.add_argument('--config', type=str, default='../experiments/transtd_fasternet/config.yaml',
        help='config file')
...
def main():
    ...
    # build tracker
    tracker = TransTDTracker(model, cfg.TRACK)
